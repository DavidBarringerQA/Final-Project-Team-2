...
DROP TABLE if EXISTS choonz_user CASCADE;
...
CREATE TABLE choonz_user (id bigint GENERATED BY DEFAULT AS identity, password varchar(255), ROLE varchar(255), username varchar(255) NOT null, PRIMARY KEY (id));
